...
<script type="text/javascript">
	function formValidation() {
		...
		if (document.getElementById("username").value == null
			...
			return false;
		} else if (document.getElementById("password").value >= 8
				&& document.getElementById("password").value <= 16) {				
			alert(Password within range between 8 to 16);	 
			return false;
			...
			return false;
		} else if(document.getElementByID("mobile").value == 10 
				&& document.getElementById("mobile").value == isNAN(value)){
			alert("Please Enter valid mobile number and (like:9463747810)")
			return false;	
	...
	var returnPhoto = function(cellVal, options, rowObject) {
		...
		if (cellVal != null && cellVal != 'null' && cellVal != '-1'
				&& cellVal != '0')
		...
		$("#jqGrid1").jqGrid(
				{
					...
					datatype : 'xml',
					mtype : 'GET',
					colNames : [ 'ID', 'User Name', 'email', 'Mobile',
							'Address', 'Photo' ],
	...
	<div id="wrapper">
		...
		<form name="login-form" class="login-form" action="checkRegister"
			...
			<div class="header">
				...
				<div id="dialog" title="List of Registerd Users"
					style="display: none;">
					<table id="jqGrid1"></table>
					<div id="jqGridPager1"></div>
				</div>

				<a href="#" onclick="showDialog()"> <h4>Check list of registered users</h4></a>
			</div>
			...
			<div class="content">
				...
				<div class="pass-icon"></div>
				<br> <br> <input type="file" name="photo" id="photo" /> <font
					color="red" size="2.5px;">*Height and Width must not exceed
					100px.</font>
			</div>
