...
<rows> <%
 	...
 	StringBuilder sql = new StringBuilder(
 			"SELECT ID ,uid ,exam_type,start_time,no_of_qos,studentName,corrent_ans,status " + " FROM  result");
...
%><row id="<%=obj.getId()%>"> <cell><%=obj.getId()%></cell> <cell><%=obj.getUserId()%></cell>
<cell><%=obj.getUserName()%></cell> <cell><%=obj.getExamType()%></cell>
<cell><![CDATA[<%=obj.getNoOfQos()%>]]></cell> <cell><![CDATA[<%=obj.getCorAns()%>]]></cell>
<cell><![CDATA[<%=obj.getsTime()%>]]></cell> <cell><![CDATA[<%=obj.getStatus()%>]]></cell>
